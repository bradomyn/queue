...
#> 7 		1 ms -> 100 us 	64 -> 1500 bytes	# full load
#> 7 		3 ms -> 100 us 	64 -> 1500 bytes	# normal load
#> 7 		5 ms -> 100 us 	64 -> 1500 bytes	# low load
...
def step(time, data):
    for packet in data:
        if packet["value"] == 0:
            ...
            packet["value"] = packet["min"] #random.randint(packet["min"], packet["max"])
